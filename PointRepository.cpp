...
int PointRepository::area2(int pointA, int pointB, int pointC)
{
...
bool PointRepository::isInCircunsphere(int pointA, int pointB, int pointC, int pointD)
{
    /**
     * |Ax Ay Ax^2+Ay^2 1|
     * |Bx By Bx^2+By^2 1| > 0
...
{
    int o1 = area2(p1, q1, p2);
    int o2 = area2(p1, q1, q2);
    int o3 = area2(p2, q2, p1);
    int o4 = area2(p2, q2, q1);
...
int compare(const void *vp1, const void *vp2)
{
    ...
    // Find orientation
    int o = PointRepository::instance()->area2(p0, p1, p2);
