...
void TestCaseGenerator::testInHullPointDistribution()
{
    ...
    for (int i = 0; i < trialsCount; i++)
    {
        ...
        int percent = pdg.randomInt(1, maxValue);
    ...
    float giftPercent = (timesGiftbetter * maxValue)/trialsCount;
    float grahanPercent = (timesGrahanBetter * maxValue)/trialsCount;
    float samePercent = (areBothEqual * maxValue)/trialsCount;
